...
#include <stdint.h>
#include <string>
class org_freedesktop_Avahi_Server
 : public DBus::InterfaceProxy {
protected:
org_freedesktop_Avahi_Server(std::string name );
public:
    static std::shared_ptr<org_freedesktop_Avahi_Server> create(std::string name = "org.freedesktop.Avahi.Server" );
...
#endif /* ORG_FREEDESKTOP_AVAHI_SERVER_H */
