#ifndef ORG_FREEDESKTOP_AVAHI_SERVER__H
#define ORG_FREEDESKTOP_AVAHI_SERVER__H

#include <dbus-cxx.h>
#include <memory>
#include <stdint.h>
#include <string>
class org_freedesktop_Avahi_Server2
 : public DBus::InterfaceProxy {
protected:
org_freedesktop_Avahi_Server2(std::string name );
public:
    static std::shared_ptr<org_freedesktop_Avahi_Server2> create(std::string name = "org.freedesktop.Avahi.Server2" );
    ...
    DBus::Path DomainBrowserPrepare(int32_t interface, int32_t protocol, std::string domain, int32_t btype, uint32_t flags );
    DBus::Path ServiceTypeBrowserPrepare(int32_t interface, int32_t protocol, std::string domain, uint32_t flags );
    DBus::Path ServiceBrowserPrepare(int32_t interface, int32_t protocol, std::string type, std::string domain, uint32_t flags );
    DBus::Path ServiceResolverPrepare(int32_t interface, int32_t protocol, std::string name, std::string type, std::string domain, int32_t aprotocol, uint32_t flags );
    DBus::Path HostNameResolverPrepare(int32_t interface, int32_t protocol, std::string name, int32_t aprotocol, uint32_t flags );
    DBus::Path AddressResolverPrepare(int32_t interface, int32_t protocol, std::string address, uint32_t flags );
    DBus::Path RecordBrowserPrepare(int32_t interface, int32_t protocol, std::string name, uint16_t clazz, uint16_t type, uint32_t flags );
protected:
...
#endif /* ORG_FREEDESKTOP_AVAHI_SERVER__H */
